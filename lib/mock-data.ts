...
export const tasks: Task[] = [
  {
    ...
    description: "Create the foundational design system",
    status: "done",
    priority: "high",
  ...
  },
  {
    ...
    description: "Design landing page and marketing materials",
    status: "in-progress",
    priority: "high",
    assignee: teamMembers[2],
    projectId: "p2",
  ...
  },
  {
    ...
    description: "Plan and execute social media launch",
    status: "todo",
    priority: "medium",
...
export const projects: Project[] = [
  {
    ...
    description:
      "Next-generation project management platform with AI capabilities",
    phase: "development",
    progress: 65,
...
export const documents: Document[] = [
  ...
  {
    id: "d5",
    title: "Q2 Marketing Presentation",
    type: "presentation",
    projectId: "p2",
...
export const gitCommits: GitCommit[] = [
  ...
  },
  {
    id: "c5",
    hash: "q3r4s5t",
    message: "style: update component styling",
    author: teamMembers[0],
...
export const gitBranches: GitBranch[] = [
  {
    name: "main",
    isDefault: true,
    lastCommit: "2026-03-26T09:15:00",
    author: teamMembers[0],
  },
  {
    name: "feature/auth",
    isDefault: false,
    lastCommit: "2026-03-26T10:30:00",
    author: teamMembers[3],
  },
  {
    name: "feature/ui-refresh",
    isDefault: false,
    lastCommit: "2026-03-25T11:00:00",
    author: teamMembers[0],
  },
  {
    name: "docs/api",
    isDefault: false,
    lastCommit: "2026-03-25T16:45:00",
    author: teamMembers[4],
  },
  {
    name: "hotfix/security",
    isDefault: false,
    lastCommit: "2026-03-24T08:30:00",
    author: teamMembers[4],
  },
];
...
export const notifications: Notification[] = [
  {
    id: "n1",
    title: "New Comment",
    message: 'Sarah commented on your task "Build dashboard components"',
    type: "info",
    read: false,
    timestamp: "2026-03-26T10:45:00",
    link: "/development/projects/p1",
  },
  {
    id: "n2",
    title: "Sprint Completed",
    message: "Sprint 11 has been marked as completed",
    type: "success",
    read: false,
    timestamp: "2026-03-26T09:00:00",
    link: "/development/sprints",
  },
  {
    id: "n3",
  ...
  },
  {
    ...
    type: "error",
    read: true,
    timestamp: "2026-03-25T18:30:00",
    link: "/development/git",
  },
  {
    id: "n5",
    title: "Team Member Added",
    message: "Michael Brown joined the Anka Platform v2.0 project",
    type: "info",
    read: true,
...
export const users: User[] = [
  {
    ...
    role: "admin",
    department: "Development",
    avatar: "/avatars/usama.jpg",
    status: "active",
    lastActive: "2026-03-26T11:00:00",
  ...
  },
  {
    ...
    avatar: "/avatars/sarah.jpg",
    status: "active",
    lastActive: "2026-03-26T10:30:00",
  ...
  },
  {
    ...
    avatar: "/avatars/james.jpg",
    status: "active",
    lastActive: "2026-03-26T09:45:00",
  ...
  },
  {
    ...
    avatar: "/avatars/emily.jpg",
    status: "active",
    lastActive: "2026-03-26T11:15:00",
  ...
  },
  {
    ...
    avatar: "/avatars/michael.jpg",
    status: "inactive",
    lastActive: "2026-03-24T16:00:00",
  ...
  },
  {
    ...
    avatar: "/avatars/lisa.jpg",
    status: "active",
    lastActive: "2026-03-26T10:00:00",
  ...
  },
  {
    ...
    status: "suspended",
    lastActive: "2026-03-20T09:00:00",
...
export const rules: Rule[] = [
  {
    ...
    description: "Automatically assign critical priority tasks to team leads",
    category: "workflow",
    enabled: true,
    conditions: ["priority == critical", "assignee == null"],
    actions: ["assign to team lead", "send notification"],
    createdBy: "Alex Chen",
  ...
  },
  {
    ...
    description: "Send reminder 24 hours before task due date",
    category: "notification",
    enabled: true,
    conditions: ["due_date - now <= 24h"],
    actions: ["send email", "push notification"],
    createdBy: "Sarah Miller",
    createdAt: "2026-02-01",
  },
  {
    id: "r3",
    name: "Restrict project deletion",
    description: "Only admins can delete projects with active tasks",
    category: "access",
    enabled: true,
    conditions: ["action == delete", "project.tasks > 0"],
    actions: ["require admin role", "log action"],
    createdBy: "Alex Chen",
  ...
  },
  {
    ...
    actions: ["require 2fa", "block if not enabled"],
    createdBy: "Alex Chen",
  ...
  },
  {
    ...
    description: "Automatically close sprint when all tasks are done",
    category: "workflow",
    enabled: false,
    conditions: ["sprint.tasks.all.status == done"],
    actions: ["close sprint", "generate report"],
    createdBy: "Sarah Miller",
    createdAt: "2026-03-01",
  },
];
...
export const departments: Department[] = [
  {
    ...
    projects: projects.filter((p) => p.phase === "development"),
  },
  {
    id: "dep2",
    name: "Product",
    ...
    projects: projects.filter((p) => p.phase === "product-modeling"),
  },
  {
    id: "dep3",
    name: "Design",
  ...
  },
  {
    ...
    projects: projects.filter((p) => p.phase === "marketing"),
  },
];
